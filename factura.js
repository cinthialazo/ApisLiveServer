var UrlGetFactura='http://localhost:90/G9_20/controller/Facturas.php?op=GetFacturas';
var UrlPostFactura='http://localhost:90/G9_20/controller/Facturas.php?op=InsertFactura';
var UrlGetUno='http://localhost:90/G9_20/controller/Facturas.php?op=GetUno';
var UrlPutFactura='http://localhost:90/G9_20/controller/Facturas.php?op=UpdateFactura';
var UrlDeleteFactura='http://localhost:90/G9_20/controller/Facturas.php?op=DeleteFactura';
